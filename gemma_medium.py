...
def run_benchmark(dataset_name, output_file='results.csv', checkpoint_file='checkpoint.pkl',
                  model_name="google/gemma-3-12b-it", num_video_frames=32, filter_media_type=None):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="gemma3_12b_benchmark_results_video.csv", help="Output CSV file path")
    parser.add_argument("--checkpoint", type=str, default="gemma3_12b_checkpoint_video.pkl", help="Checkpoint file path")
