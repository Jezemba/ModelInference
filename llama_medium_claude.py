...
def run_benchmark(dataset_name, output_file='results_claude.csv', checkpoint_file='checkpoint_claude.pkl',
                  model_name="claude-sonnet-4-5-20250929", num_video_frames=8):
    """
    ...
    print(f"\n🚀 Starting processing with Claude API...")
...
if __name__ == "__main__":
    ...
    OUTPUT_FILE = "claude_benchmark_results.csv"
    CHECKPOINT_FILE = "claude_checkpoint.pkl"

    # Claude Models:
    # - "claude-sonnet-4-5-20250929" (Claude 4.5 Sonnet - latest and most capable)
